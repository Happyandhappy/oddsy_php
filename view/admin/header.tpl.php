...
<aside> <a id="mnav-alt"><i class="icon reorder"></i></a> <a href="<?php echo ADMINURL;?>/" class="logo"><?php echo (App::Core()->logo) ? '<img src="' . SITEURL . '/uploads/' . App::Core()->logo . '" alt="'.App::Core()->company . '">': App::Core()->company;?></a>
  <div class="menuwrap">
    <nav>
      <ul>
        <li<?php if (count($this->segments) == 1) echo ' class="active"';?>><a href="<?php echo ADMINURL;?>"><i class="icon inverted rounded desktop negative"></i><span><?php echo Lang::$word->ADM_DASH;?></span></a></li>
        <li<?php if (Utility::in_array_any(["templates","menus","pages","languages","fields","coupons"], $this->segments)) echo ' class="active"';?>><a class="collapsed"><i class="icon inverted rounded columns negative"></i><span><?php echo Lang::$word->ADM_CONTENT;?></span></a>
          <ul>
        ...
        <li<?php if (in_array("users", $this->segments)) echo ' class="active"';?>><a href="<?php echo Url::url("/admin/users");?>"><i class="icon inverted rounded users negative"></i><span><?php echo Lang::$word->ADM_USERS;?></span></a></li>
        
        <li<?php if (in_array("layout", $this->segments)) echo ' class="active"';?>><a href="<?php echo Url::url("/admin/layout");?>"><i class="icon inverted rounded content left negative"></i><span><?php echo Lang::$word->ADM_LAYOUT;?></span></a></li>
        
        
        <li<?php if (in_array("memberships", $this->segments)) echo ' class="active"';?>><a href="<?php echo Url::url("/admin/memberships");?>"><i class="icon inverted rounded membership negative"></i><span>Memberships</span></a></li>
        
        <li<?php if (in_array("modules", $this->segments)) echo ' class="active"';?>><a href="<?php echo Url::url("/admin/modules");?>"><i class="icon inverted rounded layer alt negative"></i><span>Modules</span></a></li>

<?php if (Auth::hasPrivileges('manage_plugins')):?>
        <li<?php if (in_array("plugins", $this->segments)) echo ' class="active"';?>><a href="<?php echo Url::url("/admin/plugins");?>"><i class="icon inverted rounded cogs negative"></i><span><?php echo Lang::$word->PLUGINS;?></span></a></li>
        <?php endif;?>
        
        <li<?php if (Utility::in_array_any(["backup", "manager", "mailer", "countries", "configuration"], $this->segments)) echo ' class="active"';?>><a class="collapsed"><i class="icon inverted rounded wrench negative"></i><span>Configuration</span></a>
          <ul>
